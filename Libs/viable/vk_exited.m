%% VK_EXITED Indicate whether a point has exited the constraint set.
...
%
%   Standard usage:
%   exited_on = vk_exited(x, K, delta_fn, controlmax);
%
...
%
% See also: TOOLS, TOOLS/VK_BOUND, TOOLS/VK_OPTIONS, TOOLS/VK_VIABLE
function exited_on = vk_exited(x, K, delta_fn, controlmax, varargin)
