%% VK_4DGUI_MAKE_SIMULATION Create the sim_state structure.
...
%   - 'constraint_set': A constraint set, K
%   - 'controlmax': The maximum allowed control.
...
function sim_state = vk_4dgui_make_simulation(start, time_horizon, ...
    control_fn, V, distances, layers, K, delta_fn, controlmax, varargin)  
    ...
    [T, path, normpath, controlpath, viablepath] = sim_fn(start, time_horizon, ...
        control_fn, V, distances, layers, K, delta_fn, ...
        controlmax, options);
