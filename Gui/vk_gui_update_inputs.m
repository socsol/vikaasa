...
function handles = vk_gui_update_inputs(hObject, handles)
    ...
    set(handles.vartable, 'Data', project.vardata);
    ...
    set(handles.discretisation, 'String', ...
        num2str(project.discretisation));
    ...
    %% Simulation options
    set(handles.sim_start, 'RowName', project.vardata(:, 2));
    ...
    %% Slices
    set(handles.slices, 'RowName', project.vardata(:, 2));
